...
Ext.application({
    ...
    models:['Settings','Favorites','Comments','AfishaModels.CachedData', 'AfishaModels.Categories','AfishaModels.Events','AfishaModels.Places','AfishaModels.Schedule','AfishaModels.Dictionary','AfishaModels.ScheduleList','News.NewsList','News.PageView','Discount.DiscView','Discount.DiscList','News.NewsRubric'],
    stores:['Settings','Favorites','Comments','AfishaStores.Cache', 'AfishaStores.Categories','AfishaStores.LifeSubCategories','AfishaStores.Events','AfishaStores.Places','AfishaStores.Schedule','AfishaStores.Dictionary','News.NewsList','News.PageView','Discount.DiscView','Discount.DiscList','News.NewsRubric','Discount.DiscRubric'],
