...
ChildBrowser.prototype.close = function() {
	window.plugins.childBrowser.user_closing = true;
...
ChildBrowser.prototype._onEvent = function(data) {
    ...
    if (data.type == ChildBrowser.CLOSE_EVENT && typeof window.plugins.childBrowser.onClose === "function") {
		...
		window.plugins.childBrowser.onClose(window.plugins.childBrowser.user_closing);
		window.plugins.childBrowser.user_closing = undefined;
    }
