            ...
            items:[{
                ...
                items:[{
                        ...
                        tpl: new Ext.XTemplate(
                            ...
                            '<tpl if="image && this.isNews(values.image)"><p align="center"><img style="display:none;" onload="this.style.setProperty(\'display\',\'block\');" class="title-img" src="http://mobile.afisha-uu.ru/{image}"></img></p></tpl>',
